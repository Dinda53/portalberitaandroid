package com.example.portalberitaadinda
...
import com.example.portalberitaadinda.activity.HomeFragment
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toogle = ActionBarDrawerToggle(this@MainActivity , drawer,
        0,0)
